package com.yuyou.yiyuanduobao.download.dbcontrol;
...
public class FileHelper {
    private static String userID = "leefeng";
    private static String baseFilePath = FileUtils.getDownloadDir();
