 ...
 */
public class SwipeMenuLayout extends RelativeLayout implements SwipeSwitch {
    /**
     * Left menu.
     */
...
//    private int mRightViewId = 0;
    ...
    public SwipeMenuLayout(Context context, View contentView) {
        this(context);
...
//            View view = findViewById(mLeftViewId);
            float width = 100 * getResources().getDisplayMetrics().density;
            ...
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams((int) (width), mContentView.getMeasuredHeight());
            layoutParams.addRule(RelativeLayout.ALIGN_PARENT_RIGHT);
            tv.setLayoutParams(layoutParams);
            mSwipeLeftHorizontal = new SwipeLeftHorizontal(tv);
        }
